...
import com.netty.demo.netty190608_end.packet.*;
...
public class PacketCodeC {
    ...
    static {
        ...
        packetTypeMap.put(Command.GROUP_MSG_REQUEST, GroupSendMsgRequestPacket.class);
        packetTypeMap.put(Command.GROUP_MSG_RESULT, GroupSendMsgResponsePacket.class);
